          ...
          <div class="article-grid-info">
            <div class="author">
              ...
              <div class="author-info">
                ...
                <div class="likes">
                  <img src="<?= get_template_directory_uri() . '/assets/images/heart-white.svg'; ?>" alt="icon: like" class="likes-icon">
      ...
      <li class="article-post-item">
        <a href="<?= get_permalink() ?>" class="article-post-permalink">
          ...
          <div class="article-post-half article-post-info">
            ...
            <h4 class="article-post-title"><?= mb_strimwidth(get_the_title(), 0, 65, '...') ?></h4>
            ...
            <div class="article-info">
              ...
              <div class="likes">
                <img src="<?= get_template_directory_uri() . '/assets/images/heart.svg'; ?>" alt="icon: like" class="likes-icon">
                <span class="likes-counter"><?php comments_number('0', '1', '%') ?></span>
              </div>
            </div>
          </div>
